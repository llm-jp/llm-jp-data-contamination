...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=RelaTrBlack160mIdx0.log
#SBATCH --error=RelaTrBlack160mIdx0.err
#SBATCH --mem=150G
...
srun --ntasks=1 --gres=gpu:1 bash -c "$(declare -f srun_parallel); srun_parallel relative 160m truncated 0 0 4" &
# 等待所有任务结束
wait