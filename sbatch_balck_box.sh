...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=AbsBlack6.9bIdx1.log
#SBATCH --error=AbsaBlack6.9b.err
#SBATCH --mem=150G
...
srun --ntasks=1 --gres=gpu:1 bash -c "$(declare -f srun_parallel); srun_parallel absolute 6.9b truncated 0 1 2" &
# 等待所有任务结束
wait