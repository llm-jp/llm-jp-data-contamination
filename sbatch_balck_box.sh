...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=AbsUnBlack2.8bIdx2.log
#SBATCH --error=AbsUnaBlack2.8bIdx2.err
#SBATCH --mem=150G
...
srun --ntasks=1 --gres=gpu:1 bash -c "$(declare -f srun_parallel); srun_parallel absolute 2.8b untruncated 0 2 2" &
# 等待所有任务结束
wait