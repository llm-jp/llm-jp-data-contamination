...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=RelaTrBlack1bIdx2.log
#SBATCH --error=RelaTrBlack1bIdx2.err
#SBATCH --mem=150G
...
srun --ntasks=1 --gres=gpu:1 bash -c "$(declare -f srun_parallel); srun_parallel relative 1b truncated 0 2 2" &
# 等待所有任务结束
wait