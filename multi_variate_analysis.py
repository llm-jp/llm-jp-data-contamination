...
loss_train_std = scaler.fit(np.array(loss_dict[dataset_name]["train"]))
loss_test_std = scaler.transform(np.array(loss_dict[dataset_name]["test"]))
prob_train_std = scaler.fit(np.array(prob_dict[dataset_name]["train"]))
prob_test_std = scaler.transform(np.array(prob_dict[dataset_name]["test"]))
ppl_train_std = scaler.fit(np.array(ppl_dict[dataset_name]["train"]))
ppl_test_std = scaler.transform(np.array(ppl_dict[dataset_name]["test"]))
mink_plus_train_std = scaler.fit(np.array(mink_plus_dict[dataset_name]["train"]))
mink_plus_test_std = scaler.transform(np.array(mink_plus_dict[dataset_name]["test"]))
zlib_train_std = scaler.fit(np.array(zlib_dict[dataset_name]["train"]))
zlib_test_std = scaler.transform(np.array(zlib_dict[dataset_name]["test"]))
