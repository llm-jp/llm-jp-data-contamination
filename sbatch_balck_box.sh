...
#SBATCH --output=RelaBlack12b.log
#SBATCH --error=RelaBlack12b.err
...
srun --ntasks=1 --cpus-per-task=8 --gres=gpu:1 bash -c "$(declare -f srun_parallel); srun_parallel relative 12b truncated 0 2 4" &
# 等待所有任务结束
wait