...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=AbsUnBlack6.9bIdx1.log
#SBATCH --error=AbsUnaBlack6.9bIdx1.err
#SBATCH --mem=150G
...
srun --ntasks=1 --gres=gpu:1 bash -c "$(declare -f srun_parallel); srun_parallel absolute 6.9b untruncated 0 1 2" &
# 等待所有任务结束
wait