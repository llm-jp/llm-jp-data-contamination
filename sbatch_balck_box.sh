...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=AbsTrBlack160mbIdx1.log
#SBATCH --error=AbsTrBlack160mIdx1.err
#SBATCH --mem=150G
...
srun --ntasks=1 --gres=gpu:1 bash -c "$(declare -f srun_parallel); srun_parallel absolute 160m truncated 0 1 2" &
# 等待所有任务结束
wait