...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=AbsBlack2.8bIdx1.log
#SBATCH --error=AbsaBlack2.8b.err
#SBATCH --mem=150G
...
srun --ntasks=1 --gres=gpu:1 bash -c "$(declare -f srun_parallel); srun_parallel absolute 2.8b truncated 0 1 4" &
# 等待所有任务结束
wait