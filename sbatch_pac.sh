...
#SBATCH --output=pac1bat.log
#SBATCH --error=pac1bat.err
...
# 启动并行任务
srun --ntasks=1 --cpus-per-task=8 --gres=gpu:1 bash -c "$(declare -f srun_parallel); srun_parallel absolute 1b truncated 0 0 4" &
