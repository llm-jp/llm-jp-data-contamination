...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=AbsUntrBlack2.8bIdx0.log
#SBATCH --error=AbsUntrBlack2.8bIdx0.err
#SBATCH --mem=150G
...
srun --ntasks=1 --gres=gpu:1 bash -c "$(declare -f srun_parallel); srun_parallel absolute 2.8b untruncated 0 0 2" &
# 等待所有任务结束
wait