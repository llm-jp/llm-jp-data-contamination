...
#SBATCH --output=pac160mau.log
#SBATCH --error=pac160mau.err
...
# 启动并行任务
srun --ntasks=1 --cpus-per-task=8 --gres=gpu:1 bash -c "$(declare -f srun_parallel); srun_parallel absolute 160m untruncated 0 0 4" &
