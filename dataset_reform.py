...
for dataset_name in dataset_names:
    ...
    print("average member length", sum([sum(x.split()) for x in dataset["member"]])/len(dataset["member"]))
    print("aberage member length", sum([sum(x.split()) for x in dataset["nonmember"]])/len(dataset["nonmember"]))
