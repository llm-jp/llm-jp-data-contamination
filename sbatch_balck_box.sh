...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=RelaTrBlack1bIdx1.log
#SBATCH --error=RelaTrBlack1bIdx1.err
#SBATCH --mem=150G
...
srun --ntasks=1 --gres=gpu:1 bash -c "$(declare -f srun_parallel); srun_parallel absolute 1b truncated 0 1 2" &
# 等待所有任务结束
wait