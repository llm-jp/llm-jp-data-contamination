...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=RelaTrBlack12bIdx2.log
#SBATCH --error=RelaTrBlack12bIdx2.err
#SBATCH --mem=150G
...
srun --ntasks=1 --gres=gpu:1 bash -c "$(declare -f srun_parallel); srun_parallel relative 12b truncated 0 2 2" &
# 等待所有任务结束
wait